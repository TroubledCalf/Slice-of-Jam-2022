...
label start:
    label day_1:
        ...
        "You have no idea how long you stay on the bed like that."
        "As you raise your head and look around the room, it occurs to you"
        "There is not a single clock in the room"
        "Nor is there a window."
        "How long has it been since you came here? Since you woke up? Since your captor even left?"
        "You have no idea."
        v "..."
        "The tears begin to resurface again"
        "The best you can do is lie in wait."
        "Someone will come for you eventually? Right?"
        "Right?"
